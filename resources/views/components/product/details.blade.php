<div {{ $attributes->merge([]) }}>
    ...
    <a wire:navigate href="{{ route('categories.show', $product->category) }}" class="rounded-full bg-primary-500/10 hover:bg-primary-500/20 px-3 py-1 mt-2 inline-block text-xs font-semibold leading-6 text-primary-400 ring-1 ring-inset

;(() => {
    ...
    var Ei = (l, h, a, c) => {
        if ((h && typeof h == "object") || typeof h == "function")
            for (let s of Pi(h)) !Oi.call(l, s) && s !== a && he(l, s, {get: () => h[s], enumerable: !(c = Ti(h, s)) || c.enumerable})
        return l
    }
    var Li = (l, h, a) => ((a = l != null ? Ci(xi(l)) : {}), Ei(h || !l || !l.__esModule ? he(a, "default", {value: l, enumerable: !0}) : a, l))
    var me = Ai((vt, It) => {
        ;(function (h, a) {
            ...
            return (function (l) {
                ...
                return (
                    (a.m = l),
                        ...
                        (a.r = function (c) {
                            typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(c, Symbol.toStringTag, {value: "Module"}),
                                Object.defineProperty(c, "__esModule", {value: !0})
                        }),
                        (a.t = function (c, s) {
                            if ((s & 1 && (c = a(c)), s & 8 || (s & 4 && typeof c == "object" && c && c.__esModule))) return c
                            var f = Object.create(null)
                            if ((a.r(f), Object.defineProperty(f, "default", {enumerable: !0, value: c}), s & 2 && typeof c != "string"))
                                for (var d in c)
                                    a.d(
                                        f,
                                        d,
                                ...
                                (b.prototype.encodedLength = function (v) {
                                    ...
                                    (b.prototype.encode = function (v) {
                                        ...
                                        if (I > 0) {
                                            ...
                                            ;(y += this._encodeByte((O >>> (3 * 6)) & 63)),
                                                (y += this._encodeByte((O >>> (2 * 6)) & 63)),
                                                I === 2 ? (y += this._encodeByte((O >>> (1 * 6)) & 63)) : (y += this._paddingCharacter || ""),
                                    ...
                                    (b.prototype.decode = function (v) {
                                        ...
                                        if (
                                            ...
                                            ((J = this._decodeChar(v.charCodeAt(q))),
                                                ...
                                                (M |= J & s),
                                                (M |= F & s)),
                                            q < w - 2 && ((z = this._decodeChar(v.charCodeAt(q + 2))), (O[I++] = (F << 4) | (z >>> 2)), (M |= z & s)),
                                            q < w - 3 && ((B = this._decodeChar(v.charCodeAt(q + 3))), (O[I++] = (z << 6) | B), (M |= B & s)),
                                            M !== 0)
                                        )
                        ...
                        for (var T = new Uint8Array(d(P)), S = 0, C = 0; C < P.length; C++) {
                            ...
                            x < 128
                                ...
                                : x < 2048
                                    ...
                                    : x < 55296
                                        ? ((T[S++] = 224 | (x >> 12)), (T[S++] = 128 | ((x >> 6) & 63)), (T[S++] = 128 | (x & 63)))
                                        : (C++,
                                            (x = (x & 1023) << 10),
                ...
                function (l, h, a) {
                    ...
                    var c = (function () {
                            ...
                            return (
                                (e.prototype.load = function (t, n, r) {
                                    ...
                                    (e.prototype.getRoot = function (t) {
                                        ...
                                        return (
                                            (t && t.useTLS) || r === "https:" ? (n = this.options.cdn_https) : (n = this.options.cdn_http),
                        ...
                        S = new P({cdn_http: d.cdn_http, cdn_https: d.cdn_https, version: d.VERSION, suffix: d.dependency_suffix, receivers: T}),
                        C = {
                                        ...
                                        if (o.status === 200) {
                                            ...
                                            try {
                                                ...
                                                i(
                                                    new B(
                                                        200,
                                                        "JSON returned from " + r.toString() + " endpoint was invalid, yet status code was 200. Data was: " + o.responseText
                                                    ),
                                                    null
                                                )
                                            }
                    ...
                    for (var nt = String.fromCharCode, Z = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Te = {}, ct = 0, Pe = Z.length; ct < Pe; ct++)
                        Te[Z.charAt(ct)] = ct
                    var xe = function (e) {
                    ...
                    var Xe = (function () {
                        ...
                        Je = function (e, t, n, r, i) {
                            ...
                            A.warn("To send headers with the " + r.toString() + " request, you must use AJAX, rather than JSONP.")
                            ...
                            return (
                                (e.prototype.send = function (t) {
                                    ...
                                    ;(n.script = document.createElement("script")),
                                        ...
                                        n.script.async === void 0 && document.attachEvent && /opera/i.test(navigator.userAgent)
                    ...
                    var sn = (function () {
                                ...
                                (e.prototype.bind = function (t, n, r) {
                                    ...
                                    (e.prototype.emit = function (t, n, r) {
                                        ...
                                        var o = this.callbacks.get(t),
                                            u = []
                                        if ((r ? u.push(n, r) : n && u.push(n), o && o.length > 0)) for (var i = 0; i < o.length; i++) o[i].fn.apply(o[i].context || window, u)
                            ...
                            return (
                                (t.prototype.handlesActivityChecks = function () {
                                    ...
                                    (t.prototype.connect = function () {
                                        ...
                                        return this.bindListeners(), A.debug("Connecting", {transport: this.name, url: r}), this.changeState("connecting"), !0
                                    }),
                                    ...
                                    (t.prototype.onClose = function (n) {
                                        n ? this.changeState("closed", {code: n.code, reason: n.reason, wasClean: n.wasClean}) : this.changeState("closed"),
                                    ...
                                    (t.prototype.changeState = function (n, r) {
                                        ;(this.state = n), this.timeline.info(this.buildTimelineMessage({state: n, params: r})), this.emit(n, r)
                                    }),
                        ...
                        vn = new tt({
                            ...
                            getSocket: function (e, t) {
                                return new window.SockJS(e, null, {js_path: S.getPath("sockjs", {useTLS: t.useTLS}), ignore_null_origin: t.ignoreNullOrigin})
                            },
                    ...
                    var _n = ht,
                            ...
                            return (
                                (e.prototype.createConnection = function (t, n, r, i) {
                                    ...
                                    var u = this.transport.createConnection(t, n, r, i),
                                        ...
                                        g = function (k) {
                                            if ((u.unbind("closed", g), k.code === 1002 || k.code === 1003)) o.manager.reportDeath()
                        ...
                        Vt = {
                            ...
                            processHandshake: function (e) {
                                ...
                                if (t.event === "pusher:connection_established") {
                                    ...
                                    return {action: "connected", id: t.data.socket_id, activityTimeout: t.data.activity_timeout * 1e3}
                                } else {
                                    if (t.event === "pusher:errors") return {action: this.getCloseAction(t.data), error: this.getCloseError(t.data)}
                            ...
                            getCloseError: function (e) {
                                return e.code !== 1e3 && e.code !== 1001 ? {type: "PusherError", data: {code: e.code, message: e.reason || e.message}} : null
                            },
                        },
                        K = Vt,
                        Cn = (function () {
                                ...
                                (e.prototype.close = function () {
                                    ...
                                    (e.prototype.bindListeners = function () {
                                        ...
                                        ;(this.onMessage = function (n) {
                                            ...
                                            r.action === "connected"
                                                ? t.finish("connected", {connection: new Pn(r.id, t.transport), activityTimeout: r.activityTimeout})
                            ...
                            return (
                                (t.prototype.authorize = function (n, r) {
                                    ...
                                    (t.prototype.handleEvent = function (n) {
                                        var r = n.event,
                                            i = n.data
                                        if (r === "pusher_internal:subscription_succeeded") this.handleSubscriptionSucceededEvent(n)
                                        else if (r === "pusher_internal:subscription_count") this.handleSubscriptionCountEvent(n)
                                    ...
                                    (t.prototype.handleSubscriptionSucceededEvent = function (n) {
                                        ;(this.subscriptionPending = !1),
                                            (this.subscribed = !0),
                                            this.subscriptionCancelled ? this.pusher.unsubscribe(this.name) : this.emit("pusher:subscription_succeeded", n.data)
                                    }),
                                        ...
                                        ((this.subscriptionPending = !0),
                                            ...
                                            this.authorize(this.pusher.connection.socket_id, function (r, i) {
                                                r
                                                    ...
                                                    : n.pusher.send_event("pusher:subscribe", {auth: i.auth, channel_data: i.channel_data, channel: n.name})
                                            }))
                                    }),
                        ...
                        Hn = function (e, t) {
                            ...
                            function _(g) {
                                ...
                                for (; n;)
                                    try {
                                        if (((r = 1), i && (o = g[0] & 2 ? i.return : g[0] ? i.throw || ((o = i.return) && o.call(i), 0) : i.next) && !(o = o.call(i, g[1])).done))
                                            return o
                                                ...
                                                switch (g.label) {
                                                    case 0:
                                                        return o
                                                            ? [3, 3]
                                                            : ((u = u),
                                                                u.channel_data == null ? [3, 1] : ((p = JSON.parse(u.channel_data)), this.members.setMyID(p.user_id), [3, 3]))
                                                    case 1:
                                                        return [4, this.pusher.user.signinDonePromise]
                                                    case 2:
                                                        if ((g.sent(), this.pusher.user.user_data != null)) this.members.setMyID(this.pusher.user.user_data.id)
                                                        else
                                                            return (
                                    ...
                                    (t.prototype.handleSubscriptionSucceededEvent = function (n) {
                                        ;(this.subscriptionPending = !1),
                                            ...
                                            this.subscriptionCancelled
                                                ...
                                                : (this.members.onSubscription(n.data), this.emit("pusher:subscription_succeeded", this.members))
                                    }),
                                    (t.prototype.disconnect = function () {
                            ...
                            return (
                                (t.prototype.authorize = function (n, r) {
                                    ...
                                    (t.prototype.handleEncryptedEvent = function (n, r) {
                                        ...
                                        if (p === null) {
                                            A.debug("Failed to decrypt an event, probably because it was encrypted with a different key. Fetching a new key from the authEndpoint..."),
                                    ...
                                    (t.prototype.buildHandshakeCallbacks = function (n) {
                                        ...
                                        return U({}, n, {
                                            connected: function (i) {
                                                ;(r.activityTimeout = Math.min(r.options.activityTimeout, i.activityTimeout, i.connection.activityTimeout || 1 / 0)),
                        ...
                        Zn = (function () {
                            ...
                            return (
                                (e.prototype.getAssistant = function (t) {
                                    return G.createAssistantToTheTransportManager(this, t, {minPingDelay: this.options.minPingDelay, maxPingDelay: this.options.maxPingDelay})
                                }),
                                        ...
                                        var r = this,
                                            ...
                                            _ = function (g, k) {
                                                k
                                                    ...
                                                    r.loop && (o = o % i.length),
                                                        o < i.length
                                                            ? (u && ((u = u * 2), r.timeoutLimit && (u = Math.min(u, r.timeoutLimit))),
                                                                (p = r.tryStrategy(
                                                                    i[o],
                                                                    t,
                                                                    {
                    ...
                    var pr = function (e, t, n) {
                            ...
                            var o = Object.assign({}, t, {hostNonTLS: e.wsHost + ":" + e.wsPort, hostTLS: e.wsHost + ":" + e.wssPort, httpPath: e.wsPath}),
                                u = Object.assign({}, o, {useTLS: !0}),
                                p = Object.assign({}, t, {hostNonTLS: e.httpHost + ":" + e.httpPort, hostTLS: e.httpHost + ":" + e.httpsPort, httpPath: e.httpPath}),
                                ...
                                Ot
                            return (
                                t.useTLS ? (Ot = new kt([ie, new lt(xt, {delay: 2e3})])) : (Ot = new kt([ie, new lt(_i, {delay: 2e3}), new lt(xt, {delay: 5e3})])),
                        ...
                        vr = function () {
                            var e = this
                            e.timeline.info(e.buildTimelineMessage({transport: e.name + (e.options.useTLS ? "s" : "")})),
...
`)
                            ...
                            return (
                                (e.prototype.send = function (t) {
                                    ...
                                    (e.prototype.onClose = function (t, n, r) {
                                        this.closeStream(), (this.readyState = $.CLOSED), this.onclose && this.onclose({code: t, reason: n, wasClean: r})
                                    }),
                                    ...
                                    (e.prototype.onOpen = function (t) {
                                        this.readyState === $.CONNECTING
                                            ? (t && t.hostname && (this.location.base = Pr(this.location.base, t.hostname)), (this.readyState = $.OPEN), this.onopen && this.onopen())
                                    ...
                                    (e.prototype.openStream = function () {
                                        var t = this
                                        ;(this.stream = m.createSocketRequest("POST", Kt(this.hooks.getReceiveURL(this.location, this.session)))),
                        ...
                        Dr = (function () {
                            ...
                            return (
                                (e.prototype.log = function (t, n) {
                                    ...
                                    (this.events.push(U({}, n, {timestamp: j.now()})), this.options.limit && this.events.length > this.options.limit && this.events.shift())
                                }),
                    ...
                    var Fr = m.Transports,
                        ...
                        Kr = Qr,
                        Yr = function (e, t, n) {
                            var r = {authTransport: t.transport, authEndpoint: t.endpoint, auth: {params: t.params, headers: t.headers}}
                            return function (i, o) {
                    ...
                    function ii(e, t) {
                        ...
                        return (
                            "channelAuthorization" in e
                                ...
                                "auth" in e && ("params" in e.auth && (n.params = e.auth.params), "headers" in e.auth && (n.headers = e.auth.headers)),
                    ...
                    var hi = ui,
                                ...
                                return (
                                    (r.signin_requested = !1),
                                        ...
                                        r.pusher.connection.bind("state_change", function (i) {
                                            ...
                                            o === "connected" && u !== "connected" && (r._cleanup(), r._newSigninPromiseIfNeeded())
                                        }),
                                        (r.watchlist = new ci(n)),
                                        r.pusher.connection.bind("message", function (i) {
                                            var o = i.event
                                            o === "pusher:signin_success" && r._onSigninSuccess(i.data),
                                            r.serverToUserChannel && r.serverToUserChannel.name === i.channel && r.serverToUserChannel.handleEvent(i)
                                        }),
                                        r
                                )
                            }
                            ...
                            return (
                                (t.prototype.signin = function () {
                                        ...
                                        var n = this,
                                            r = function (i) {
                                                i.subscriptionPending && i.subscriptionCancelled
                                                    ...
                                                    : !i.subscriptionPending && n.pusher.connection.state === "connected" && i.subscribe()
                                            }
                                        ;(this.serverToUserChannel = new bt("#server-to-user-" + this.user_data.id, this.pusher)),
                                    ...
                                    (t.prototype._cleanup = function () {
                                        ...
                                        (this.serverToUserChannel.unbind_all(), this.serverToUserChannel.disconnect(), (this.serverToUserChannel = null)),
                        ...
                        ee = (function () {
                            function e(t, n) {
                                ...
                                "disableStats" in n && A.warn("The disableStats option is deprecated in favor of enableStats"),
                                    (this.key = t),
                                    ...
                                    (e.prototype.subscribe = function (t) {
                                        ...
                                        return (
                                            n.subscriptionPending && n.subscriptionCancelled
                                                ...
                                                : !n.subscriptionPending && this.connection.state === "connected" && n.subscribe(),
                                                n
                                        )
                                    }),
                ...
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s, f) {
                            ...
                            (this.events[s] && (this.socket.removeListener(s, this.events[s]), delete this.events[s]), delete this.listeners[s])
                        },
                    },
                ]),
                    a
                ...
                R(l, [
                    {
                        ...
                        value: function (a) {
                            ...
                            return (
                                c && ((this.options.auth.headers["X-CSRF-TOKEN"] = c), (this.options.userAuthentication.headers["X-CSRF-TOKEN"] = c)),
                                    (c = this.options.bearerToken),
                                c && ((this.options.auth.headers.Authorization = "Bearer " + c), (this.options.userAuthentication.headers.Authorization = "Bearer " + c)),
                                    a
                            )
                        },
                    },
                        ...
                        value: function () {
                            ...
                            return typeof window < "u" && window.Laravel && window.Laravel.csrfToken
                                ...
                                : this.options.csrfToken
                                    ? this.options.csrfToken
                                    : typeof document < "u" && typeof document.querySelector == "function" && (a = document.querySelector('meta[name="csrf-token"]'))
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-" + s] || (this.channels["private-" + s] = new ve(this.pusher, "private-" + s, this.options)), this.channels["private-" + s]
                            )
                        },
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-encrypted-" + s] || (this.channels["private-encrypted-" + s] = new qi(this.pusher, "private-encrypted-" + s, this.options)),
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["presence-" + s] || (this.channels["presence-" + s] = new Ui(this.pusher, "presence-" + s, this.options)),
            ...
            return (
                R(a, [
                    ...
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["private-" + s] || (this.channels["private-" + s] = new ge(this.socket, "private-" + s, this.options)), this.channels["private-" + s]
                            )
                        },
                    },
                    {
                        ...
                        value: function (s) {
                            return (
                                this.channels["presence-" + s] || (this.channels["presence-" + s] = new Di(this.socket, "presence-" + s, this.options)),
                                    this.channels["presence-" + s]
                            )
                        },
                    },
            ...
            return (
                R(l, [
                    ...
                    },
                    {
                        key: "connect",
                        value: function () {
                            if (this.options.broadcaster == "reverb") this.connector = new fe(at(at({}, this.options), {cluster: ""}))
                            ...
                            else if (typeof this.options.broadcaster == "function" && Ni(this.options.broadcaster)) this.connector = new this.options.broadcaster(this.options)
                            else throw new Error("Broadcaster ".concat(st(this.options.broadcaster), " ").concat(this.options.broadcaster, " is not supported."))
                        },
                    },
                    {
                        key: "disconnect",
                    ...
                    },
                    {
                        ...
                        value: function (a) {
                            if (this.connector instanceof pe)
                                throw new Error(
                                    "Broadcaster ".concat(st(this.options.broadcaster), " ").concat(this.options.broadcaster, " does not support encrypted private channels.")
                                )
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            (typeof Turbo > "u" ? "undefined" : st(Turbo)) === "object" && this.registerTurboRequestInterceptor()
                        },
                    },
                    {

...
var require_module_cjs = __commonJS({
    "../alpine/packages/alpinejs/dist/module.cjs.js"(exports, module) {
        ...
        function handleError(error2, el, expression = void 0) {
            error2 = Object.assign(error2 != null ? error2 : { message: "No errors message given." }, { el, expression })
            console.warn(
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`,
                ...
                if (closest) {
                    ...
                    nextTick2(() => {
                        let hideAfterChildren = (el2) => {
                            let carry = Promise.all([el2._x_hidePromise, ...(el2._x_hideChildren || []).map(hideAfterChildren)]).then(([i]) => (i == null ? void 0 : i()))
        ...
        function warnMissingPluginDirective(name, directiveName, slug) {
            directive2(directiveName, (el) =>
                warn(`You can't use [x-${directiveName}] without first installing the "${name}" plugin here: https://alpinejs.dev/plugins/${slug}`, el)
            )
        }
        ...
        var require_dist = __commonJS2({
            "node_modules/tabbable/dist/index.js"(exports2) {
                ...
                var isHidden = function isHidden2(node, _ref) {
                    ...
                    var nodeIsAttached =
                        (nodeRootHost === null || nodeRootHost === void 0 ? void 0 : nodeRootHost.ownerDocument.contains(nodeRootHost)) || node.ownerDocument.contains(node)
...
function applyDelay(directive2) {
    if (!directive2.modifiers.includes("delay") || directive2.modifiers.includes("none")) return [(i) => i(), (i) => i()]
    let duration = 200
    let delayModifiers = {
        shortest: 50,
        shorter: 100,
